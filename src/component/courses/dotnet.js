...
*/}
  ...
  <div className="breadcrumb__area include-bg pt-200 pb-150" style={{paddingTop: 50, paddingBottom: 50, backgroundImage:"url(assets/img/breadcrumb/computer1.jpg)"}} data-background="assets/img/breadcrumb/computer1.jpg">
    <div className="container">
      <div className="row">
        <div className="txtwidth" style={{fontSize: 27, fontWeight: 800, color: 'white', paddingBottom: 33, textDecoration: 'underline'}}>Microsoft Dotnet / C# Training</div>
        <div style={{fontSize: 18, color: 'white', paddingBottom: 33}}>.NET courses are designed to equip learners with the skills and knowledge needed to build applications on the .NET framework. These courses cover a wide range of topics, including web development, desktop applications, and database management.
        </div>
      </div>
      ...
      <div className="row">
        <div className="col-lg-12">
          <div style={{background: '#f3f1ee', padding: 29}}>
            <p style={{borderBottom: '2px solid red', fontSize: 30, fontWeight: 700, paddingBottom: 25}}>Microsoft Dotnet / C# Training</p>
          </div>
          <div className="accordion" id="myAccordion">
            <div className="accordion-item">
              <h2 className="accordion-header" id="headingOne">
                <button type="button" className="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapseOne" style={{fontWeight: 800, fontSize: 18}}>Microsoft Dotnet Syllabus</button>									
              </h2>
              <div id="collapseOne" className="accordion-collapse collapse" data-bs-parent="#myAccordion">
                <div className="card-body">
                  ...
                  </p><li>Basic Concept of OOPs?</li>
                  <li>Principles of OOPs</li>
                  <li>Object</li>
                  <li>Class</li>
                  <li>Abstraction</li>
                  <li>Encapsulation</li>
                  ...
                  <li>Polymorphism</li>
                  <li>Overloading</li>
                  <b>Introduction to .Net Framework</b>
                  <li>.Net Framework Architecture</li>
                  <li>Components of framework</li>
                  <li>CTS</li>
                  <li>CLS</li>
                  <li>CLR</li>
                  <li>FCL</li>
                  ...
                  <li>Windows Forms</li>
                  <li>Assembly Types</li>
                  <li>GAC</li>
                  <li>Build, Package, and Deploy</li>
                  <b>C# Language</b>
                  <li>CLR Execution Model</li>
                  <li>Primitive Types</li>
                  <li>Reference &amp; Value Types</li>
                  <li>Nullable Types</li>
                  <li>Constants &amp; Fields</li>
                  <li>Properties, Methods, Events &amp; Delegates.</li>
                  <li>Generics</li>
                  <li>Interfaces</li>
                  <li>Working with Chars, Strings &amp; Text</li>
                  <li>Enums, Arrays.</li>
                  <li>Assembly Loading &amp; Reflection</li>
                  <li>Serialization</li>
                  <b>Errors &amp; Exception Handling – Dot Net Syllabus</b>
                  <li>The Idea behind Exception</li>
                  <li>Exceptions &amp; Errors</li>
                  <li>Types of Exception</li>
                  <li>Control Flow in Exceptions</li>
                  <li>Use of try, catch, finally, throw, and throws in Exception Handling.</li>
                  <li>In-built and User Defined Exceptions</li>
                  <b>Collections</b>
                  <li>Collection Classes</li>
                  <li>List, Dictionary, Hashtable</li>
                  <b>Threading</b>
                  <li>Thread Basics</li>
                  <li>Foreground, Background Threads</li>
                  <li>Multithreading concepts</li>
                  <li>Asynchronous Operations using threads</li>
                  <b>Windows Forms</b>
                  <li>Basics of Winforms programming</li>
                  <li>Controls in Winforms</li>
                  <li>Execution flow</li>
                  <li>Event Driven programming</li>
                  <li>Assignments</li>
                  <b>ADO .Net – Dot Net Syllabus</b>
                  <li>Basics of RDBMS</li>
                  <li>ADO .Net Classes</li>
                  <li>Connectivity to Database</li>
                  <li>Connected &amp; Disconnected Architecture</li>
                  <li>Dataset, Datatable, DataReader</li>
                  <b>ASP .Net</b>
                  <li>Introduction to Web Applications</li>
                  <li>Why ASP .Net?</li>
                  <li>IIS</li>
                  <li>ASP .Net Pipeline</li>
                  <li>Page Life Cycle</li>
                  <li>Front end and Code Behind</li>
                  <li>User Controls</li>
